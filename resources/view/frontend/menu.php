                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($data)) { ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo htmlspecialchars($row['menu_image']); ?>" alt="<?php echo htmlspecialchars($row['menu_name']); ?>" style="width: 50px; height: auto;"></td>
                                        <td><?php echo htmlspecialchars($row['nama_lengkap']); ?></td> <!-- Display full name -->
                                        ...
                                        <td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="editmenu.php" method="post" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="id_login" class="col-sm-4 col-form-label">Modified By <span class="mandatory-icon">*</span></label>
                                                                    <div class="col-sm-8">
                                                                        <!-- Automatically select the current logged-in user -->
                                                                        <select id="id_login" class="form-select" name="id_login" readonly>
                                                                            <option value="<?php echo $nama_lengkap; ?>"><?php echo htmlspecialchars($nama_lengkap); ?></option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                            ...
                                            <a class="dbi bi-trash" href="deletemenu.php?id_menu=<?php echo $row['id_menu']; ?>" onclick="return confirm('Are you sure you want to delete this user?');"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
