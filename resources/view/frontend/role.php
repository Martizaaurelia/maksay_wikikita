<?php
// include properti
include('resources/view_admin/templates/header.php');
...
<main id="main" class="main">
    ...
    <div class="card-body">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form action="addrole.php" method="post" enctype="multipart/form-data">
                                ...
                                while ($row = mysqli_fetch_array($data)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="dbi bi-trash" href="deleterole.php?id_role=<?php echo $row['id_role']; ?>" onclick="return confirm('Are you sure you want to delete this user?');"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<?php
// include properti
include('resources/view_admin/templates/footer.php');
?>