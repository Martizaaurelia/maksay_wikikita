...
<body>
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item d-block d-lg-none">
          <a class="nav-link nav-icon search-bar-toggle" href="javascript:void(0);" onclick="toggleSearchBar()">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="view/frontend/menu.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="role.php">
          <i class="bi bi-person"></i>
          <span>Role</span>
        </a>
      </li><!-- End Profile Page Nav -->
