...
<main id="main" class="main">
    ...
    <div class="card-body">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form action="view/backend/adduser.php" method="post" enctype="multipart/form-data">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <label for="NIK" class="col-sm-2 col-form-label">NIK <span class="mandatory-icon">*</span></label>
                                <div class="col-sm-10">
                                ...
                                while ($row = mysqli_fetch_array($data)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="editModal_<?php echo $row['id_login']; ?>" tabindex="-1" aria-labelledby="editModalLabel_<?php echo $row['id_login']; ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="view/backend/edituser.php" method="post" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="NIK" class="col-sm-4 col-form-label">NIK <span class="mandatory-icon">*</span></label>
                                                                    <div class="col-sm-8">
                                            ...
                                            <a class="dbi bi-trash" href="view/backend/deleteuser.php?id_login=<?php echo $row['id_login']; ?>" onclick="return confirm('Are you sure you want to delete this user?');"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
